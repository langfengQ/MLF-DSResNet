...
from parallel_nets.VGGnet_for_cifar10 import VGG16
...
def data_model_load(args, model, kwargs):
    train_dataset = datasets.CIFAR10('./data', True, download=True,
    ...
    test_dataset = datasets.CIFAR10('./data', False, download=True,
                                     transform=transforms.Compose([
                                         transforms.ToTensor(),
                                         transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010))
                                     ]))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--total-epochs', type=int, default=110, help='number of epochs to train')
    ...
    parser.add_argument('--checkpoint-path', type=str, default='./checkpoint/cifar10/result_cifar10.pth',
